...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "pt-br": {
        ...
        "map": "Mapa",
        "use": "Usar",
        "no_events": "Nenhum evento disponível",
        "no_quests": "Nenhuma missão disponível",
        "reset_game_confirmation": "Tem certeza que deseja reiniciar o jogo? Isso apagará todo o progresso.",
        "home": "Início",
        "select_race": "Selecione a Raça",
        "select_class": "Selecione a Classe",
        "character_description_placeholder": "Descreva seu personagem...",
        "character_description_hint": "Dica: Fale sobre a aparência, história ou personalidade.",
        "health_stamina": "Vida / Energia",
        "health_stamina_hint": "Mostra seus pontos de vida e energia atuais.",
        "max_hp": "Vida Máxima",
        "current_hp": "Vida Atual",
        "max_stamina": "Energia Máxima",
        "current_stamina": "Energia Atual",
    ...
    "en": {
        ...
        "reset_game_confirmation": "Are you sure you want to reset the game? This will erase all progress.",
        "home": "Home",
        "select_race": "Select Race",
        "select_class": "Select Class",
        "character_description_placeholder": "Describe your character...",
        "character_description_hint": "Hint: Talk about appearance, story, or personality.",
        "health_stamina": "Health / Stamina",
        "health_stamina_hint": "Shows your current health and stamina points.",
        "max_hp": "Max HP",
