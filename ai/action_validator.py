...
def validate_action_with_ai(action: str, details: str, location: str, ai_client=None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.warning("Unexpected validation response format", extra={"response": str(result)[:100]})
        return {"valid": True}
